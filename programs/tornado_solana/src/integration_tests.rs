...
mod integration_tests {
    ...
    /// Test the endianness conversion functions
    #[test]
    fn test_endianness_conversion() {
        ...
        let converted = change_endianness(&original);
        let double_converted = change_endianness(&converted);
    ...
    #[test]
    fn test_proof_a_negation_format() {
