...
mod relayer_validation_tests {
    ...
    fn test_relayer_account_mismatch_attack() {
        ...
        // 3. Verify it fails with TornadoError::RelayerMismatch
    ...
    fn test_self_pay_attack_prevention() {
        ...
        // In a real implementation, this would trigger TornadoError::RecipientCannotBeRelayer
...
mod relayer_fee_validation_tests {
    ...
    fn test_fee_calculation_overflow_protection() {
        ...
        let normal_denomination = 1_000_000_000; // 1 SOL
        let normal_fee = 100_000_000; // 0.1 SOL
